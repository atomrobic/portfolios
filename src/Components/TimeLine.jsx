...
const RoadmapUI = () => {
  const roadmapData = [
    {
      quarter: "2024–Present",
      year: "Freelancer",
      icon: Star,
      items: [
        "Freelance Full Stack Developer",
        "Working on client & personal SaaS projects",
        "React, Django, FastAPI based systems",
        "Portfolio & automation tools development"
      ]
    },
    {
      quarter: "2022–2024",
      ...
      icon: Smartphone,
      items: [
        "Python Django Developer – iHub (2 Years)",
        "Built scalable Django backends",
        "Integrated REST APIs with frontend frameworks",
        "Optimized database queries & authentication"
      ]
    },
    {
      quarter: "2021–2022",
      ...
      icon: Coins,
      items: [
        "Freelance Developer at GG Net Solutions",
        "Built custom web apps for clients",
        "Developed REST APIs & responsive UIs",
        "Managed deployments & client requirements"
      ]
    },
    {
      quarter: "2023",
      ...
      icon: View,
      items: [
        "Full Stack Developer Intern – Mashupstack (8 Months)",
    ...
    },
    {
      ...
      icon: Rocket,
      items: [
        "Completed BA Degree – Kerala University",
        "Built foundation in HTML, CSS & JavaScript",
        "Started learning Python for web development"
      ]
    }
  ];
  ...
  return (
    <div id="experience" className="min-h-screen bg-[#0a0a0a] text-slate-100 font-sans selection:bg-slate-400/30 overflow-x-hidden relative">
      <style>{`
      ...
      <main className="relative w-full py-12 md:py-20 px-4 topographic-bg">
        ...
        {/* MOBILE HEADING (NEW) */}
        <h2 className="text-center text-2xl font-bold text-white tracking-widest mb-10 lg:hidden">
          EXPERIENCE
        </h2>
        ...
        >
          <h2 className="text-[8rem] md:text-[10rem] font-black uppercase tracking-widest text-white">
            EXPERIENCE
          </h2>
        </motion.div>

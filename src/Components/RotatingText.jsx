...
export default function RotatingTextDemo() {
  return (
    <div className="flex justify-center md:justify-start mt-6 sm:mt-8">
      ...
      >
        <RotatingText
          texts={["Django", "React", "Next.js"]}
          mainClassName="px-4 sm:px-5 md:px-6 bg-cyan-300 text-black overflow-hidden py-1.5 sm:py-2 md:py-2.5 justify-center rounded-full font-semibold shadow-lg"
          staggerFrom="last"
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
          exit={{ y: "-120%" }}
